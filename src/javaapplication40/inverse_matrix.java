 ...
 * @author Masud Ali
 */
public class inverse_matrix extends javax.swing.JFrame {

    /**
     * Creates new form inverse_matrix
     */
    ...
    private void initComponents() {
        ...
        jLabel4.setText("Inverse Matrix");
    ...
    static boolean inverse(float A[][], float [][]inverse,int N)
{
        ...
        for (int in = 0; in < sz;) {
          ...
          float [][]inv = new float[n][n];
           ...
           if (inverse(a, inv,n)){
                 for (i = 0; i < n; i++) {
              for(j=0;j<n;j++){
                if(!(i==0&&j==0)) ans=ans+c+c;
                 float dd=inv[i][j];
                 String tem=df.format(inv[i][j]);
                ans = ans + tem;
             } 
             ans+="\n";
           }
           }else ans="Singular matrix, can't find its inverse";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(inverse_matrix.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new inverse_matrix().setVisible(true);
            }
        });
    }
